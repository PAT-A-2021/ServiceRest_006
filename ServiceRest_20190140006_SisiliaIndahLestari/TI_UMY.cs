...
using static ServiceRest_20190140006_SisiliaIndahLestari.CompositeType;

namespace ServiceRest_20190140006_SisiliaIndahLestari
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-2J1AS4M; Initial Catalog=TI UMY; Persist Security Info=True; User ID=sa; Password=indah18");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-2J1AS4M; Initial Catalog=TI UMY; Persist Security Info=True; User ID=sa; Password=indah18");
